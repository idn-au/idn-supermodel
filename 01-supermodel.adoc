= Indigenous Data Network Supermodel
:toc: left
:table-stripes: even
:sectnums:
...
|===
|**IRI** | https://linked.data.gov.au/def/idn-supermodel __Note the IRI for this data model being in a gov.au domain will require endorsement by IIRC governance processes__
|**altDevIRI** | http://idnau.org/def/sm __Possible "under development" version at IDN domain?????__
...
|**Machine-readable form** | https://surroundaustralia.github.io/idn-supermodel/supermodel.ttl[supermodel.ttl]
|===
...
| **`super`** | **`https://linked.data.gov.au/def/idn-supermodel/`** | **this model**
...
1. http://pid.geoscience.gov.au/def/sm/data-domains/sampling[Observations]
2. http://pid.geoscience.gov.au/def/sm/data-domains/data-cataloguing[Data Cataloguing]
3. http://pid.geoscience.gov.au/def/sm/data-domains/organisations-people[Organisations & People]
